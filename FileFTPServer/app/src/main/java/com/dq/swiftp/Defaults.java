...
public class Defaults {
	...
	private static int dataChunkSize = 65536;  // do file I/O in 64k chunks 
	private static int sessionMonitorScrollBack = 10;
	private static int serverLogScrollBack = 10;
	private static int uiLogLevel = Defaults.release ? Log.INFO : Log.DEBUG;
	private static int consoleLogLevel = Defaults.release ? Log.INFO : Log.DEBUG;
...
//	protected static int ipRetrievalAttempts = 5;
	...
	public static final String PATH_INTERNAL = File.separator + STR_INTERNAL + File.separator;
	public static final String PATH_EXTERNAL = File.separator + STR_EXTERNAL + File.separator;
